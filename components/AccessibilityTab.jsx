...
const AccessibilityTab = () => {
    ...
    return (
        <>
            ...
            <div
                className="fixed left-0 top-3/4 transform -translate-y-1/2 z-50"
                onMouseEnter={() => setIsHovered(true)}
                onMouseLeave={() => setIsHovered(false)}
            >
                <div className="bg-secondary text-primary p-2 rounded-r-lg shadow-lg hover:bg-tertiary transition-all duration-300 flex flex-col items-center gap-1 min-h-[200px] justify-center cursor-pointer">
                    <div className="flex flex-col items-center gap-1">
                        <div className="mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 483.2226563 551.4306641" className="text-primary">
            ...
            {/* Accessibility Panel */}
            {isHovered && (
                <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="fixed left-0 top-3/4 transform -translate-y-1/2 z-40 bg-white border border-gray-300 rounded-r-lg shadow-xl p-6 w-80 ml-8">

                    <div className="space-y-4">
                        <div>
                            <h3 className="font-semibold text-dark mb-4">Accessibility Help</h3>
