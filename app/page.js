    ...
    <div className="flex flex-col items-center justify-center w-full h-full">
      <div id="welcome" className="w-11/12 flex flex-col items-center justify-center gap-4 rounded-lg my-6">
        ...
        <div className="relative flex flex-col items-center justify-center gap-4 w-full">
          <div className="flex flex-col items-center justify-center gap-6 bg-primary p-8 rounded-lg opacity-90 text-secondary">
      ...
      <div className="flex flex-wrap items-center justify-evenly w-full bg-primary text-secondary px-4 py-8">
        {icons.map((icon) => (
          <Link href={icon.link} key={icon.title} className="flex flex-col items-center justify-between gap-2 w-1/7 dental-icons">
            ...
            <div className="flex flex-col items-center justify-center">
              <h2 className="font-bold text-2xl text-secondary text-center">{icon.title}</h2>
              <p className="font-bold text-xl text-tertiary">{icon.subtext}</p>
            </div>
          </Link>
        ))}
      </div>

      <div className="flex items-center justify-evenly w-full text-primary bg-secondary p-4">
        <div className="flex flex-col items-center justify-evenly w-1-4">
