...
const pageContent = [
    { heading: '', text: ['Above all else, we here at Hentges Dental (formerly Christensen Family Dentistry) want our patients to maintain healthy, bright, and beautiful smiles! Next to that, we want our patients to feel comfortable and content during their appointments with us. Both of these goals begin with patient education! Staying informed can help you better understand the tenants of good oral health, prevent potential problems, and reveal why certain treatments are necessary.'], imgSrc: office5 },
